...
const LoginLanding = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overscroll-y-auto min-h-screen">
            ...
            {portalOptions.map((portal) => (
              ...
              >
                <div className="relative z-10 flex items-center justify-between gap-4 sm:gap-5">
                  ...
                  <ArrowRightIcon className="w-4 h-4 text-slate-400 group-hover:text-indigo-600 group-hover:trnaslate-x-1 transtion-all duration-300"/>
                </div>
